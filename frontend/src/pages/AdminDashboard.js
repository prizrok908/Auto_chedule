  ...
  return (
    <div className="content">
      ...
      <div className="guide-section">
        <h2>📖 Руководство: С чего начать</h2>
        
        <div className="guide-card">
          <div className="guide-step">
            <div className="step-number">1</div>
            <div className="step-content">
              <h3>🏫 Добавьте кабинеты</h3>
              <p>Перейдите в раздел <strong>"Кабинеты"</strong> и создайте кабинеты для занятий</p>
              <ul>
                <li>Обычные кабинеты: 101, 102, 103...</li>
                <li>Специальные: Компьютерный класс, Спортзал, Кабинет труда</li>
              </ul>
            </div>
          </div>
          ...
          <div className="guide-step">
            ...
            <div className="step-content">
              <h3>👨‍🏫 Добавьте учителей</h3>
              <p>Перейдите в <strong>"Пользователи → Учителя"</strong></p>
              <ul>
                <li><strong>Для 1-4 классов:</strong> отметьте "Учитель начальных классов"</li>
                <li><strong>Для 5-11 классов:</strong> после создания нажмите кнопку "Предметы" и назначьте предметы</li>
              </ul>
            </div>
          </div>
          ...
          <div className="guide-step">
            ...
            <div className="step-content">
              <h3>🎓 Создайте классы</h3>
              <p>Перейдите в <strong>"Классы"</strong> и создайте все классы (1А, 1Б, 2А...)</p>
              <ul>
                <li>Укажите классного руководителя</li>
                <li>Выберите домашний кабинет</li>
              </ul>
            </div>
          </div>
          ...
          <div className="guide-step">
            ...
            <div className="step-content">
              <h3>👨‍🎓 Добавьте учеников</h3>
              <p>Перейдите в <strong>"Пользователи → Ученики"</strong></p>
              <ul>
                <li>Добавьте учеников с ФИО и датой рождения</li>
                <li>Затем в разделе "Классы" нажмите кнопку "Ученики" и распределите по классам</li>
              </ul>
            </div>
          </div>
          ...
          <div className="guide-step">
            ...
            <div className="step-content">
              <h3>🏖️ Настройте каникулы и праздники</h3>
              <p>Перейдите в <strong>"Каникулы и праздники"</strong></p>
              <ul>
                <li>Добавьте каникулы (осенние, зимние, весенние, летние)</li>
                <li>Добавьте праздники (Новый год, 8 Марта, День Победы)</li>
                <li>Настройте переносы (рабочие субботы)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="guide-step">
            ...
            <div className="step-content">
              <h3>✨ Сгенерируйте расписание</h3>
              <p>Перейдите в <strong>"Генерация расписания"</strong></p>
              <ul>
                <li>Выберите класс</li>
                <li>Настройте предметы и количество уроков</li>
                <li>Укажите период (например: 01.09.2024 - 31.12.2024)</li>
                <li>Нажмите "Сгенерировать расписание"</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="map-section">
            ...
            <div className="map-grid">
              ...
              <div className="map-item">
                ...
                <ul>
                  <li>Обычные кабинеты</li>
                  <li>Специальные кабинеты</li>
                  <li>Вместимость</li>
                </ul>
              </div>
              <div className="map-item">
                <strong>Каникулы и праздники</strong>
                <ul>
                  <li>Праздники</li>
                  <li>Каникулы</li>
              ...
              <div className="map-item">
                ...
                <ul>
                  <li>Просмотр по неделям</li>
                  <li>Редактирование уроков</li>
                  <li>Замены учителей</li>
                </ul>
              </div>
              <div className="map-item">
                <strong>Генерация расписания</strong>
                <ul>
                  <li>Выбор класса</li>
                  <li>Настройка предметов</li>
            ...
            <div className="map-grid">
              <div className="map-item">
                ...
                <ul>
                  ...
                  <li>Классы и кабинеты</li>
                </ul>
              </div>
              <div className="map-item">
                <strong>Планы уроков</strong>
                <ul>
                  <li>Добавить план</li>
                  <li>Загрузить из Excel</li>
                </ul>
              </div>
              <div className="map-item">
                <strong>Ученики</strong>
                <ul>
                  <li>Список по классам</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="map-section">
            ...
            <div className="map-grid">
              <div className="map-item">
                <strong>Расписание</strong>
                <ul>
                  <li>Уроки на неделю</li>
                  <li>Время и кабинеты</li>
                </ul>
              </div>
              <div className="map-item">
                <strong>Домашние задания</strong>
                <ul>
                  <li>Задания по предметам</li>
                  <li>Файлы</li>
                </ul>
              </div>
            </div>
        ...
        <div className="guide-tips">
          ...
          <div className="tips-grid">
            <div className="tip-card tip-success">
              <h4>✅ Начальные классы (1-4)</h4>
              <ul>
                <li>Один учитель ведет все основные предметы</li>
                <li>Один домашний кабинет</li>
                <li>Учитель должен быть отмечен как "Учитель начальных классов"</li>
              </ul>
            </div>
            <div className="tip-card tip-info">
              <h4>✅ Старшие классы (5-11)</h4>
              <ul>
                <li>Разные учителя для разных предметов</li>
                <li>Учителю нужно назначить предметы через кнопку "Предметы"</li>
                <li>Разные кабинеты для разных предметов</li>
              </ul>
            </div>
            <div className="tip-card tip-warning">
              <h4>⚠️ Система проверяет</h4>
              <ul>
                <li>Учитель не может вести два урока одновременно</li>
                <li>Кабинет не может быть занят двумя классами</li>
                <li>Учитывает праздники и каникулы</li>
                <li>Соблюдает нормы СанПиН</li>
              </ul>
            </div>
          </div>
        </div>
